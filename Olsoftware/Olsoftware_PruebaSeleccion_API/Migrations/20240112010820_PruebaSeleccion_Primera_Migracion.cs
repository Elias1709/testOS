...
{
    /// <inheritdoc />
    public partial class PruebaSeleccionPrimeraMigracion : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LenguajeProgramacion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CantidadPreguntas = table.Column<int>(type: "int", nullable: false),
                    NivelPrueba = table.Column<string>(type: "nvarchar(max)", nullable: false),
